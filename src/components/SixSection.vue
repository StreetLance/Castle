      ...
      <div class="row w-100 fix ">
        <div class="col-sm-6 fix">
          ...
          <div class="main2 " align="left">
            ...
            <span ><p class="ref2 text-white">Developer: <span class="text-grey lite-text"> Tirox Group GmbH</span></p></span>
        ...
        <div class="col-sm-6 fix"><div class="ref" id="castle"></div></div>
      </div>
    </div>
  </section>
</template>
...
<style scoped>
  ...
  hr{
    margin-top: 7%;
    width: 80%;
    border-bottom: 2px solid #c27c51;
  }
  p{
    margin-top: 7%;
    text-align: left;
